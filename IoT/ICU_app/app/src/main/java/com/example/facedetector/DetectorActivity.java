 ...
 * objects.
 */
public class DetectorActivity extends com.example.facedetector.CameraActivity implements OnImageAvailableListener {
  ...
  private static final String TF_OD_API_MODEL_FILE = "ear.tflite"; //이어폰감지
  private static final String TF_OD_API_LABELS_FILE = "labelmapear.txt";
      ...
      public void onInit(int status) {
        if (status == TextToSpeech.SUCCESS) {
          ...
          if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
            Toast.makeText(DetectorActivity.this, "이 언어는 지원하지 않습니다.", Toast.LENGTH_SHORT).show();
          } else {
            //음성 톤
            tts.setPitch(0.7f);
            //읽는 속도
  ...
  public void saveImage(Bitmap bitmap){
    ...
    try {
      ...
      String imageFileName = userPass+"_1_"+timeStemp+".jpg";
      path.mkdirs();
      Log.d("save", "path 생성");
  ...
  public void showDlg() {
    CustomDialog3 dlg = new CustomDialog3(this);

    dlg.callDialog3();

  }
  public void showDlg1() {
    CustomDialog4 dlg = new CustomDialog4(this);
        ...
        new Runnable() {
          ...
          public void run() {
            ...
            if(resultscore < 50){
              ...
              if(Count == 200) {
                Speech1();
                runOnUiThread(DetectorActivity.this::showDlg1);
              ...
              if (location != null && result.getConfidence() >= minimumConfidence) {
                ...
                if(resultscore >= 90) {
                  ...
                  if(Count2 == 10){
                    ...
                    Speech();
                    runOnUiThread(DetectorActivity.this::showDlg);
