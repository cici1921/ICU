...
public class CustomDialog5 extends AppCompatActivity {
    ...
    public void callDialog5()
    {
        final Dialog dialog = new Dialog(activity);

        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setContentView(R.layout.activity_custom_dialog5);
        dialog.show();
        Intent data = activity.getIntent();
        userPass = data.getStringExtra("userPass");
        Log.d("userPass","custom5"+userPass);
